...
class ModelEMA(object):
    ...
    Args:
        ...
        decay (int):  The decay used for updating ema parameter.
           ...
           `ema_param = decay * ema_param + (1 - decay) * cur_param`.
            Defaults is 0.9998.
        decay_type (str): type in ['threshold', 'normal', 'exponential'],
        ...
        black_list (set|list|tuple, optional): The custom EMA black_list.
    ...
    def __init__(self,
        ...
        self.black_list = self._match_ema_black_list(model.state_dict().keys(),
                                                     black_list)
